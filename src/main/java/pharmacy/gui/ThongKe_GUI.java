...
public class ThongKe_GUI {
    ...
    public void setUpStatisticCustomer() throws SQLException {
    ...
    public void renderNewMemberChart(String selectedType, LocalDate date) throws SQLException {
        CategoryAxis xAxis = new CategoryAxis();
        NumberAxis yAxis = new NumberAxis();
    ...
    public void renderTopCustomerTable() throws SQLException {
