...
public class DangNhap_GUI {
	...
	public void handleForgotPassword() {
		forgotPasswordBtn.setOnMouseEntered(e -> {
			NodeUtil.applyFadeTransition(forgotPasswordBtn, 1, 0.7, 300, () -> {
			});
		});

		forgotPasswordBtn.setOnMouseExited(e -> {
			NodeUtil.applyFadeTransition(forgotPasswordBtn, 0.7, 1, 300, () -> {
			});
		});
		...
		forgotPasswordBtn.setOnMouseClicked(e -> {
			try {
				...
				forgotPasswordBtn.getParent().getScene().getWindow().hide();
